...
<div id="mainContainer" class="container theme-showcase" style="width:900px">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div id="page-header">
                <h2 class="form-signin-heading portfolioHeader">Education</h2><br>
...
<!--                            <input data-bind="value: name" type="text" class="form-control" id="txtSchoolName" name="txtSchoolName" required autofocus=""><br>
                ...
                <div id="page-header">
                    <h2 class="form-signin-heading portfolioHeader">Research</h2><br>
<!--                    <button class="expandButton" id="editWorkButton"><span class="glyphicon glyphicon-chevron-down" aria-hidden="true" ></span></button><br><br>
        ...
        <!--    <pre data-bind="text: ko.toJSON($root.portfolios, null, 2)"></pre>--> -->
        <button class="btn" data-bind="click:  this.submitJSON(ko.toJSON($root.portfolios, null, 2))" onclick="window.location.href = 'menu.jsp'" style="margin: 5px;">Submit</button>

        <!--Allows the user to show/hide each section of the portfolio when editing-->
        <script>
